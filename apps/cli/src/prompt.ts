...
2. add_chunk for relevant changed or contextual code regions.
...
Keep the review concise and evidence-based. Do not mutate files, run package managers, access the network, or include secrets in findings.`;
}

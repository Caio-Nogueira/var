/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5aed897e2a42292e7555efef8c0010e9)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ReviewAgent: DurableObjectNamespace<import("./src/worker").ReviewAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "PUBLIC_BASE_URL">> {}
}
